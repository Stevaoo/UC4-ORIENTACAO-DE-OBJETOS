...
// Criando produtos
let TV = new ProdutoImp("Smart TV", 25000, "TCL");
let Telefone = new ProdutoImp("Celular", 50000, "Iphone 13 Pro");
let VideoGame = new ProdutoImp("Video Game", 32000, "Play 5");
...
console.log(`Lucro da TV: ${Telefone.calcularLucro()}`);
